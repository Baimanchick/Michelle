      ...
      <div className="menu-main-content">
        ...
        <div className="tea-main">
          ...
          <div className="smuzi-main">
            ...
            <SmuziSquaer title={"Шпинат"} style={{ backgroundColor: "#FFF" }} />
            <SmuziSquaer title={"Огурец"} style={{ backgroundColor: "#FFF" }} />
            <SmuziSquaer title={"Мята"} style={{ backgroundColor: "#FFF" }} />
            <SmuziSquaer
              title={"Айсберг салат"}
              style={{ backgroundColor: "#FFF" }}
            />
            <SmuziSquaer title={"Лимон"} style={{ backgroundColor: "#FFF" }} />
            <SmuziSquaer title={"Яблоко"} style={{ backgroundColor: "#FFF" }} />
            <SmuziSquaer title={"Киви"} style={{ backgroundColor: "#FFF" }} />
            <SmuziSquaer
              title={"Клубника"}
              style={{ backgroundColor: "#FFF" }}
            />
            <SmuziSquaer title={"Малина"} style={{ backgroundColor: "#FFF" }} />
            <SmuziSquaer
              title={"Смородина"}
              style={{ backgroundColor: "#FFF" }}
            />
            <SmuziSquaer title={"Банан"} style={{ backgroundColor: "#FFF" }} />
            {/*  */}
