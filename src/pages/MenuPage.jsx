  ...
  return (
    <div className={`block-breakfast`}>
      ...
      <img
        ...
        src={require(`../images/${selectedCategory.img ? selectedCategory.img : 'zavtrak'}.png`)}
      />
      <div className='body-breakfast'>
        <h1 className={`breakfast-title ${ categoryChange ? 'fade-animation' : '' } `}>{selectedCategory.name}</h1>
      ...
      {isMenuOpen && <FullscreenMenu onCloseMenu={handleCloseMenu} onSelectCategory={handleSelectCategory} selectedCategory={selectedCategory} />}
    </div>
  );
}
