...
import imgContr from "../images/else/CE3A1638_plate 3 (16).png"
import Square from "../components/Square";

function MenuBreakContruct() {
      ...
      {windowWidth <= 1000 ? (
        <div className="menu-main-content" style={{ zIndex: 2 }}>
          ...
          {selectedLanguage === "Русский" ? (
            <>
              <div className="absoulute-block">
                <img src={imgContr} className="main-img-contr" />
              </div>
              <div className="drinks-main" style={{ zIndex: 2 }}>
                <header className="tea-header" >
                  <div className="tea-header-title" style={{ zIndex: 2 }}>
                    <h2 style={{ fontSize: "38px", width: "325px" }}>КОНСТРУКТОР ЗАВТРАКА</h2>
                ...
                <div className="block-dob">
                    <div className="dob">
                        <h3>2 ЯЙЦА</h3>
                        <span style={{ fontSize: "10px", textAlign: "center" }}>(пашот / глазунья / скрэмбл / отварное / омлет)</span>
                        <span style={{ color: "#81B0B0", fontSize: "14px", width: "40px"}}>80 C</span>
                    </div>
                    <div className="dob">
                        <h3>Дополнительное яйцо</h3>
                        <span style={{ color: "#81B0B0", fontSize: "14px"}}>+ 45 C</span>
                    </div>
                </div>                
              </div>

              <div className="section2" style={{ marginTop: "25px" }}>
                <h1 style={{ fontSize: "23px", color: "#E1A304", fontWeight: "100", textAlign: "center" }}>ДОПОЛНИТЬ НАЧИНКОЙ ПО ВКУСУ</h1>
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>ОВОЩИ</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
                    ...
                    <div className="d-f">
                        ...
                        <div className="veg-block">
                            <div className="veg-p">
                                <div className="veg-title">Шампинь<br />оны</div>
                ...
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>МЯСО И РЫБА</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
                    <div className="d-f">
                        <div className="veg-block" style={{ background: "#F3998033" }}>
                            <div className="veg-p">
                                <div className="veg-title">Малосоль<br />ная сёмга</div>
                ...
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>СЫР</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
                    <div className="d-f">
                        <div className="veg-block" style={{ background: "#FBCB001A" }}>
                            <div className="veg-p">
                ...
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>ХЛЕБ</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
                    <div className="d-f">
                        <div className="veg-block" style={{ background: "#FBCB0033" }}>
                            <div className="veg-p">
            ...
            <>
              ...
              <div className="drinks-main" style={{ zIndex: 2 }}>
                <header className="tea-header" >
                  <div className="tea-header-title" style={{ zIndex: 2 }}>
                    <h2 style={{ fontSize: "38px", width: "325px" }}>Design your perfect breakfast</h2>
                    <div className="yellow-block">Available from 6:00 am to 12:00 pm</div>
                  </div>
                </header>
                ...
                <div className="block-dob">
                    <div className="dob">
                        <h3>2 eggs</h3>
                        <span style={{ fontSize: "10px", textAlign: "center" }}>(poached / fried / scrambled / boiled / omelet)</span>
                        <span style={{ color: "#81B0B0", fontSize: "14px", width: "40px"}}>80 C</span>
                    </div>
                    <div className="dob">
                        <h3>Extra egg</h3>
              ...
              <div className="section2" style={{ marginTop: "25px" }}>
                <h1 style={{ fontSize: "23px", color: "#E1A304", fontWeight: "100", textAlign: "center" }}>Choose your favorite option</h1>
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>Vegetables</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
                ...
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>Meat & Fish</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
                ...
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>Cheese</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
                ...
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>Bread</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
            ...
            <>
              ...
              <div className="drinks-main" style={{ zIndex: 2 }}>
                <header className="tea-header" >
                  <div className="tea-header-title" style={{ zIndex: 2 }}>
                    <h2 style={{ fontSize: "38px", width: "325px" }}>KAHVALTI TASARIMCISI</h2>
                    <div className="yellow-block">6:00’dan 12:00’ye kadar çalişir</div>
                  </div>
                </header>
                ...
                <div className="block-dob">
                    <div className="dob">
                        <h3>2 yumurta</h3>
                        <span style={{ fontSize: "10px", textAlign: "center" }}>(poşe / sahanda / scramble / haşlanmış / omlet)</span>
                        <span style={{ color: "#81B0B0", fontSize: "14px", width: "40px"}}>80 C</span>
                    </div>
                    <div className="dob">
              ...
              <div className="section2" style={{ marginTop: "25px" }}>
                <h1 style={{ fontSize: "23px", color: "#E1A304", fontWeight: "100", textAlign: "center" }}>Tadınıza göre íçeríkle tamamlayın.</h1>
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>Sebzeler</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
                ...
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>Et ve Balik</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
                ...
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>Peynír</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
                ...
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>Ekmek</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
            ...
            <>
              ...
              <div className="drinks-main" style={{ zIndex: 2 }}>
                <header className="tea-header" >
                  <div className="tea-header-title" style={{ zIndex: 2 }}>
                    <h2 style={{ fontSize: "38px", width: "325px" }}>ЭртеҢки тамакты конструкция</h2>
                    <div className="yellow-block">саат 6:00дөн 12:00гө чейин иштейт</div>
                  </div>
                </header>
                ...
                <div className="block-dob">
                    <div className="dob">
                        <h3>2 жумуртка</h3>
                        <span style={{ fontSize: "10px", textAlign: "center" }}>(пашот / куурулган / скрэмбл / бышырылган / омлет)</span>
                        <span style={{ color: "#81B0B0", fontSize: "14px", width: "40px"}}>80 C</span>
                    </div>
                    <div className="dob">
              ...
              <div className="section2" style={{ marginTop: "25px" }}>
                <h1 style={{ fontSize: "23px", color: "#E1A304", fontWeight: "100", textAlign: "center" }}>ТАТЫМЫНА ЖАРАША ИЧИН ТОЛУКТОО</h1>
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>Жашылчалар</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
                    ...
                    <div className="d-f">
                        ...
                        <div className="veg-block">
                            <div className="veg-p">
                                <div className="veg-title">Шампинь<br />ондор</div>
                                <div className="veg-price">50 c</div>
                            </div>
                            <div className="veg-weight">30 г</div>
                        </div>
                ...
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>Эт жана Балык</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
                    <div className="d-f">
                        <div className="veg-block" style={{ background: "#F3998033" }}>
                            <div className="veg-p">
                                <div className="veg-title">Аз туздуу кызыл балык эти</div>
                                <div className="veg-price">160 c</div>
                            </div>
                            <div className="veg-weight">30 г</div>
                        </div>
                ...
                <header className="menu-header" style={{ paddingTop: "30px" }}>
                    <div className="menu-title-container">
                      <hr />
                      <h2 style={{ textAlign: "center", fontSize: "23px" }}>Нан</h2>
                      <hr />
                    </div>
                </header>
                <div className="vegetables-grid">
...
export default MenuBreakContruct;
